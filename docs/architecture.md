...
5. اگر وضعیت وردپرس `draft` باشد، توقف workflow برای بازبینی انسانی
6. اگر وضعیت وردپرس `publish` باشد، ساخت کپشن شبکه‌های اجتماعی با لینک مقاله
7. انتشار در اینستاگرام و تلگرام طبق تنظیمات
...
کار می‌کند. اگر پست وردپرس draft باشد، تلگرام ارسال نمی‌شود چون لینک مقاله عمومی
نیست.
...
اینستاگرام skip می‌شود. اگر پست وردپرس draft باشد، اینستاگرام نیز skip می‌شود.

### 7. Providerها

هدف از Provider abstraction این است که workflow اصلی به مدل خاصی وابسته نباشد.
برای مثال می‌توان مقاله را با Groq تولید کرد و تصویر را با OpenAI ساخت، یا برای
